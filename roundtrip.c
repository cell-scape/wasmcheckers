...
u32 (*WASM_RT_ADD_PREFIX(Z_indexForPositionZ_iii))(u32, u32);
/* export: 'offsetForPosition' */
u32 (*WASM_RT_ADD_PREFIX(Z_offsetForPositionZ_iii))(u32, u32);
/* export: 'isCrowned' */
u32 (*WASM_RT_ADD_PREFIX(Z_isCrownedZ_ii))(u32);
/* export: 'isWhite' */
u32 (*WASM_RT_ADD_PREFIX(Z_isWhiteZ_ii))(u32);
/* export: 'isBlack' */
u32 (*WASM_RT_ADD_PREFIX(Z_isBlackZ_ii))(u32);
/* export: 'withCrown' */
u32 (*WASM_RT_ADD_PREFIX(Z_withCrownZ_ii))(u32);
/* export: 'withoutCrown' */
u32 (*WASM_RT_ADD_PREFIX(Z_withoutCrownZ_ii))(u32);

static void init_exports(void) {
  /* export: 'indexForPosition' */
  WASM_RT_ADD_PREFIX(Z_indexForPositionZ_iii) = (&w2c_indexForPosition);
  /* export: 'offsetForPosition' */
  WASM_RT_ADD_PREFIX(Z_offsetForPositionZ_iii) = (&w2c_offsetForPosition);
  /* export: 'isCrowned' */
  WASM_RT_ADD_PREFIX(Z_isCrownedZ_ii) = (&w2c_isCrowned);
  /* export: 'isWhite' */
  WASM_RT_ADD_PREFIX(Z_isWhiteZ_ii) = (&w2c_isWhite);
  /* export: 'isBlack' */
  WASM_RT_ADD_PREFIX(Z_isBlackZ_ii) = (&w2c_isBlack);
  /* export: 'withCrown' */
  WASM_RT_ADD_PREFIX(Z_withCrownZ_ii) = (&w2c_withCrown);
  /* export: 'withoutCrown' */
  WASM_RT_ADD_PREFIX(Z_withoutCrownZ_ii) = (&w2c_withoutCrown);
}
